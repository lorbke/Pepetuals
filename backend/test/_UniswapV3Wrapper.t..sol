...
// 		// mlsp = new MultiLongShortPair(bytes32("SACK"), WETH, address(uniswapV3Wrapper), FINDER);
// 		// lsp = mlsp.getLsp(1);
...
// 	function testNewPoolOldTokens() public {

// 		address pool = factory.createPool(UNI, WETH, 100);

// 		console.log(pool);
// 		console.log(factory.getPool(UNI, WETH, 100));
...
// 	// 	address self = address(this);
// 	// 	vm.prank(WETH);
// 	// 	weth.transfer(self, 1000e6);

// 	// 	TransferHelper.safeApprove(WETH, address(lsp), 1000e6);
// 	// 	lsp.create(1000);

// 	// 	assertNotEq(longToken.balanceOf(self), 0, "Long balance should not be zero");
// 	// 	assertNotEq(shortToken.balanceOf(self), 0, "Short balance should not be zero");
